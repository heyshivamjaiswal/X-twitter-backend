import Post from "../modelJs/post.model.js";
import User from "../modelJs/user.model.js";
...
export const commentOnPost = async (req, res)=>{
    try{
        ...
        console.log("Error in commentOnPost controllerP: ", error);
        res.status(500).json({error: "Internal server error"});
    }
}
...
export const likeUnlikePost = async (req, res) => {
    try {
        ...
        // Fix: Use postId instead of userId to find the post
        const post = await Post.findById(postId);
        ...
        // Fix: Access likes through post object
...
export const getLikedPosts = async (req , res)=>{
    ...
    try{
        ...
        console.log("Error found in getLikedPosts" , error)
        res.status(500)
